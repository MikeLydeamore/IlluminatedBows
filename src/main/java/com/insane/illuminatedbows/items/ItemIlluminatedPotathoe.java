...
public class ItemIlluminatedPotathoe extends ItemHoe {
	
	public ItemIlluminatedPotathoe()
	{
		super(ToolMaterial.EMERALD);
		this.setUnlocalizedName("illuminatedPotathoe");
	...
	{
		list.add(StatCollector.translateToLocal("potathoe.tooltip"));
	}
    ...
    {
        this.itemIcon = par1IconRegister.registerIcon("illuminatedbows:illuminatedpotathoe");
    }
	
	//100% "borrowed" from vanilla
	@Override

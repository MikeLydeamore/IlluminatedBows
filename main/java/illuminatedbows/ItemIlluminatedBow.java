...
public class ItemIlluminatedBow extends ItemBow {
	...
	public ItemIlluminatedBow(int par1) {
		super(par1);
	...
	@Override
	   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	   {
		 ArrowNockEvent event = new ArrowNockEvent(par3EntityPlayer, par1ItemStack);
	        ...
	        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Item.redstone.itemID))
	        {
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode||par3EntityPlayer.inventory.hasItem(IlluminatedBows.illuminatedArrowID+256)) {
        	...
        	//par2World.spawnEntityInWorld(new EntityIlluminatedArrow(par2World, par3EntityPlayer));
            	...
            	if (!par3EntityPlayer.capabilities.isCreativeMode||!IlluminatedBows.bowTakesDamage) { 
            		...
            		par3EntityPlayer.inventory.consumeInventoryItem(IlluminatedBows.illuminatedArrowID+256);
            	}
